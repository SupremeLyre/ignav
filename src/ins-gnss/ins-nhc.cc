...
static int bldnhc(const insopt_t *opt, const imud_t *imu, const double *Cbe, const double *ve, int nx, double *v,
                  double *H, double *R)
{
    int i, nv, IA, IV;
...
extern void clp(insstate_t *ins, const insopt_t *opt, const double *x)
{
    ...
    ins_errmodel2(ins->fb0, ins->omgb0, ins->Ma, ins->Mg, ins->ba, ins->bg, ins->Gg, fibc, omgbc);
