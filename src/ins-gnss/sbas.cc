...
/* sbas igp definition -------------------------------------------------------*/
static const short x1[] = {-75, -65, -55, -50, -45, -40, -35, -30, -25, -20, -15, -10, -5, 0,
...
EXPORT const sbsigpband_t igpband1[9][8] = {/* band 0-8 */
                                            ...
                                            {{140, x3, 1, 27},
                                             ...
                                             {170, x3, 151, 177},
                                             {175, x2, 178, 200}}};
EXPORT const sbsigpband_t igpband2[2][5] =
    {/* band 9-10 */
...
static void readmsgs(const char *file, int sel, gtime_t ts, gtime_t te, sbs_t *sbs)
{
    ...
    while (fgets(buff, sizeof(buff), fp))
    {
        ...
        {
            if (sscanf(p, "%2X", &b) == 1)
                sbs->msgs[sbs->n].msg[i] = (unsigned char)b;
        }
