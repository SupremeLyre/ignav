...
extern vec3_t *vec3_rot_axis_self(vec3_t *vo, double x, double y, double z, double angle)
{
    quat_t rotate;
...
extern void quat_from_u2v(quat_t *q, const vec3_t *u, const vec3_t *v, const vec3_t *up)
{
...
static quat_t *quat_lerp(quat_t *qo, const quat_t *qfrom, const quat_t *qto, double t)
{
...
extern quat_t *quat_nlerp(quat_t *qo, const quat_t *qfrom, const quat_t *qto, double t)
{
...
extern quat_t *quat_slerp(quat_t *qo, const quat_t *qfrom, const quat_t *qto, double t)
{
    /* calc cosine */
    double cosom = quat_dot(qfrom, qto);
 ...
 * orientation
 * --------------------------------------------------------------------------*/
extern quat_t *quat_apply_relative_yaw_pitch_roll(quat_t *q, double yaw, double pitch, double roll)
{
