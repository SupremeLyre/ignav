...
#define MODOPT                                                                                                         \
    "0:single,1:dgps,2:kinematic,3:static,4:movingbase,5:fixed,6:ppp-kine,7:ppp-static,8:ppp-fixed,9:ins-update,10:"   \
    "ins-loosely-coupled,11:ins-tightly-coupled,12:ins-vo-loosely-coupled,13:vo"
...
EXPORT opt_t insopts[] = {{"ins-leverarm1", 1, (void *)&prcopt_.insopt.lever[0], ""},
